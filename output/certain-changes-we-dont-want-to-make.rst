...
* Checking the number and type of arguments to a function which has an
  ...
  Such a feature would work only occasionallyonly for calls that appear
  ...
  * 
  ...
  compilers.  And it doesnt seem very important, given that you can get
  ...
  * 
  ...
  that claim to support ISO C, such as gcc -ansinot for other
