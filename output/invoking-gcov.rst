...
Running :command:`gcov` with your programs source file names as arguments
...
functions blocks were executed.
...
the file doesnt match the executable (differing number of basic block
